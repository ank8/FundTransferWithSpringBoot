...
class CustomerAccControllerTests {
	...
	AddAccountRequest mockAccount = null;//new AddAccountRequest("99999999999", "ICICI0000231", 125l, "token");
...
//		assertEquals(StatusMsgConstants.ACC_ADD_SUCCESS, response.getContentAsString());
//	}
